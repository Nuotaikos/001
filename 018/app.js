...
class Stikline {
  ...
  static visosStiklines(stikline) {
    this.registras.push(stikline); // statinis registratorius
  }

  constructor(turis) {
    this.turis = turis;
    this.kiekis = 0; //tuscia stikline
    this.constructor.visosStiklines(this); //registruoja visas stikline
  }
  ...
  stiklinejeYra() {
    console.log(`Stiklineje ${this.turis} ml yra: ${this.kiekis} ${this.constructor.type}`);
  }
}
const s1 = new Stikline(200);
const s2 = new Stikline(150);
